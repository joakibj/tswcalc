...
var input_path = "./src/templates/dusts/"; // directory of dust templates are stored with .dust file extension
var output_path = "./dist/templates/dusts/"; // directory where the compiled .js files should be saved to
